...
```
请求参数：charset=utf-8&data={"goods_remark":"iphone6"}&method=goods.add&format=json&app_id=2019032617262200001&sign_type=RSA2&version=1.0&timestamp=2019-04-29 19:18:38
```

其中data部分是我们想要的，在方法上申明一个对象，对应data中的内容即可完成参数绑定，并且对参数进行JSR-303校验。
...
```
----------- 请求信息 -----------
请求参数：charset=utf-8&data={}&method=story.demo.get&format=json&app_id=alipay_test&sign_type=RSA2&version=1.0&timestamp=2019-03-23 15:41:22
...
待签名内容：app_id=alipay_test&data={}&charset=utf-8&format=json&method=story.demo.get&sign_type=RSA2&timestamp=2019-03-23 15:41:22&version=1.0
