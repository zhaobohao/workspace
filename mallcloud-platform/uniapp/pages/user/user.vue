	...
	<view class="container">
		<view class="user-section">
			...
			<view class="user-info-box">
				<view class="portrait-box">
					<image class="portrait" :src="user.icon || '/static/missing-face.png'" v-if="user"></image>
					<image class="portrait" src="/static/missing-face.png" v-else></image>
				</view>
				<view class="info-box">
					<text class="username" v-if="user">{{ user.nickname }}</text>
		...
		>
			...
			<view class="tj-sction">
				<view class="tj-item">
					<text class="num">{{user.blance}}</text>
					<text>余额</text>
				</view>
				<view class="tj-item">
				...
				<view class="tj-item">
					<text class="num">{{user.integration}}</text>
					<text>积分</text>
				</view>
			</view>
			<!-- 订单 -->
