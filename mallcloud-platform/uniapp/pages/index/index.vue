	...
	<view class="container">
		...
		<view class="group-section">
			<swiper class="g-swiper" :duration="500">
				<swiper-item class="g-swiper-item" v-for="(item, index) in groupHotGoodsList" :key="index"  @click="navToGroupDetailPage(item)">
...
export default {
	...
	methods: {
		...
		async loadData() {
			...
			let params = {};
			let data1 = await Api.apiCall('get', Api.goods.home, params);
			...
			if (data1) {
				...
				let newProductList = data.newProductList;
				this.newProductList = newProductList || [];

				let hotProductList = data.hotProductList;
			...
			let groupHotGoodsList = await Api.apiCall('get', Api.goods.groupHotGoodsList, params,true);
			this.groupHotGoodsList = groupHotGoodsList.data;

			let couponList = await Api.apiCall('get', Api.marking.couponList, params,true);
