  ...
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      <div>
        ...
        <span>筛选搜索</span>
        <el-button style="float: right" @click="searchMemberList()" type="primary" size="small">
          查询结果
        </el-button>
        <el-button style="float: right" @click="updateOrderInfo()" type="primary" size="small">
          同步订单统计
        </el-button>
      </div>
      ...
      <el-table ref="brandTable" :data="list" style="width: 100%" @selection-change="handleSelectionChange"
        ...
        <el-table-column label="用户余额" width="180" align="center">
          <template slot-scope="scope">
            ...
            <p>
              <el-button type="text" @click="handleShowVeriyEditDialog(scope.$index, scope.row)">余额记录
              </el-button>
            </p>
          </template>
        </el-table-column>
        <el-table-column label="用户积分" width="180" align="center">
          <template slot-scope="scope">
            ...
            <p>
              <el-button type="text" @click="handleShowIntegrationDialog(scope.$index, scope.row)">积分记录
              </el-button>
            </p>
          </template>
        </el-table-column>
        <el-table-column label="用户状态" width="100" align="center">
          <template slot-scope="scope">
            <el-switch @change="handleShowChange(scope.$index, scope.row)" :active-value="1" :inactive-value="0"
        ...
        <el-table-column label="操作" width="250" align="center">
          <template slot-scope="scope">
            <!-- <el-button size="mini" type="danger" @click="addBlacne(scope.$index, scope.row)">余额充值
            </el-button>
            <el-button size="mini" type="danger" @click="addIntegration(scope.$index, scope.row)">积分充值
            </el-button>-->
