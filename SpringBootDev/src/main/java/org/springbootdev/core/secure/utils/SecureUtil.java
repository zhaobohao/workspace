package org.springbootdev.core.secure.utils;
...
import org.springbootdev.core.secure.TokenInfo;
...
import org.springbootdev.core.secure.provider.IClientDetails;
import org.springbootdev.core.secure.provider.IClientDetailsService;
import org.springbootdev.core.tool.utils.*;
...
public class SecureUtil {
	private static final String mk_USER_REQUEST_ATTR = "_mk_USER_REQUEST_ATTR_";
	...
	public static SystemUser getUser() {
		...
		// 优先从 request 中获取
		Object SystemUser = request.getAttribute(mk_USER_REQUEST_ATTR);
		if (SystemUser == null) {
			SystemUser = getUser(request);
			if (SystemUser != null) {
				// 设置到 request 中
				request.setAttribute(mk_USER_REQUEST_ATTR, SystemUser);
			}
		}
