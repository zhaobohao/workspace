...
package org.springbootdev.core.launch;
...
public class SpingCloudDevApplication {
	...
	public static SpringApplicationBuilder createSpringApplicationBuilder(String appName, Class source, String... args) {
		...
		props.setProperty("springbootdev.is-local", String.valueOf(isLocalDev()));
		props.setProperty("springbootdev.dev-mode", profile.equals(AppConstant.PROD_CODE) ? "false" : "true");
		props.setProperty("springbootdev.service.version", AppConstant.APPLICATION_VERSION);
		props.setProperty("spring.main.allow-bean-definition-overriding", "true");
