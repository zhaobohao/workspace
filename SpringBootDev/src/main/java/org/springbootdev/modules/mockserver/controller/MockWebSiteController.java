package org.springbootdev.modules.mockserver.controller;
...
import org.springbootdev.modules.mockserver.wrapper.MockWebSiteWrapper;
...
@AllArgsConstructor
@Slf4j
@RequestMapping("/"+ AppConstant.APPLICATION_MOCKSERVER_NAME+"/mockwebsite")
@Api(value = "", tags = "接口")
