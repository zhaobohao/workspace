...
public class MockWrapper {
	 ...
	 * @return
	 */
	public static HttpResponse mockHttpResponse(MockHttp mockHttp) {
	 ...
	 * @return
	 */
	public static HttpRequest mockForwarRequest(MockHttp mockHttp) {
	 ...
	 * @return
	 */
	public static HttpForward mockForward(MockHttp mockHttp) {
		...
		if (StrUtil.isNotBlank(mockHttp.getForwardHost())) {
			...
			if (StrUtil.isNotBlank(mockHttp.getForwardPort())) {
				httpForward.withHost(mockHttp.getForwardPort());
			}
	 ...
	 * @return
	 */
	public static HttpError mockError(MockHttp mockHttp) {
	 ...
	 * @return
	 */
	public static HttpRequest mockRequest(MockHttp mockHttp) {
