 ...
 */
@Component("userDetailProcessor")
public class UserDetailProcessor implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        for(String s:urls){
            ...
            page.addTargetRequest(s+"/activities");
...
//        System.out.println(page.getHtml());
        ...
        page.putField("pageUrl",page.getHtml().xpath("//div[@itemprop='people']/meta[@itemprop='url']/@content").toString());
        page.putField("nickname",page.getHtml().xpath("//div[@class='ProfileHeader-contentHead']/h1/span[1]/text()").toString());
...
//        userDetailInfo.setShares(Integer.valueOf(page.getHtml().xpath("//div[@class='ProfileHeader-contentHead']/h1/a/span[2]/text()").toString()));
        ...
        page.putField("addtime",new Date());
        ...
        page.putField("status",page.getHtml().xpath("//div[@class='Profile-sideColumn']/div[@class='Card']/div[2]/div[2]/div[2]/text()").toString());
        ...
        page.putField("gender",page.getHtml().xpath("//div[@class='Card FollowshipCard']/div/a[2]/div/strong/text()").toString());
...
//        spider.run();
        Spider spider = Spider.create(new UserDetailProcessor())
                .addUrl(START_URL)
