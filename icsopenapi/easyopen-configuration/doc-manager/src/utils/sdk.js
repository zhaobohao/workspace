 ...
 */
	...
	function request(opts) {
		...
		accessToken = opts.access_token || sessionStorage.getItem('access_token'),
		...
		// var jwt = sessionStorage.getItem('easyconf_jwt')
	    if(jwt) {
