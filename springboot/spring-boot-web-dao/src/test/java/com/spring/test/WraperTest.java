...
import com.spring.web.dao.entity.enums.AgeEnum;
...
@Slf4j
public class WraperTest extends BaseTest {
    ...
    @Test
    public void cUpdate() {
        assertThat(mapper.updateById(new User().setEmail("ab@c.c").setId(1L))).isGreaterThan(0);
        assertThat(
                mapper.update(
                        new User().setName("mp"),
