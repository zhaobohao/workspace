...
public class FileSourceJob2 {
    private static final Logger log = LoggerFactory.getLogger(FileSourceJob2.class);
    @Resource
    ...
    public Job dataHandleJob() {
        return jobBuilderFactory.get("FileSourceJob2").
                incrementer(new RunIdIncrementer()).
                start(handleDataStep2()).    //start是JOB执行的第一个step
//                next(xxxStep()).
//                next(xxxStep()).
//                ...
    ...
    public Step handleDataStep2() {
        return stepBuilderFactory.get("getData2").
                ...
                reader(getDataReader2()).         //指定ItemReader
                processor(getDataProcessor2()).   //指定ItemProcessor
                writer(txtItemWriter2()).         //指定ItemWriter
                build();
    }

    @Bean
    public FlatFileItemReader<? extends Access> getDataReader2() {
    ...
    @Bean
    public ItemProcessor<Access, Access> getDataProcessor2() {
    ...
    @Bean
    public FlatFileItemWriter<Access> txtItemWriter2() {
