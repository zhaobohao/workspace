...
public class SpringCloudHystrixTargeter implements Targeter {
	...
	public <T> T target(FeignClientFactoryBean factory, Feign.Builder feign, FeignContext context,
		...
		// 默认的 fallbackFactory
		SpringCloudFallbackFactory springCloudFallbackFactory = new SpringCloudFallbackFactory(target);
		return (T) builder.target(target, springCloudFallbackFactory);
	}
