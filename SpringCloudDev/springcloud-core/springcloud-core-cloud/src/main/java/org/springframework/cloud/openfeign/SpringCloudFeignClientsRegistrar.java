...
import org.springclouddev.core.cloud.feign.FeignAutoConfiguration;
 ...
 */
@NoArgsConstructor
public class SpringCloudFeignClientsRegistrar implements ImportBeanDefinitionRegistrar, BeanClassLoaderAware, EnvironmentAware {
	@Getter
