 ...
 */
@AllArgsConstructor
public class ExtraHystrixConcurrencyStrategy extends com.netflix.hystrix.strategy.concurrency.HystrixConcurrencyStrategy {
	@Nullable
	private final com.netflix.hystrix.strategy.concurrency.HystrixConcurrencyStrategy existingConcurrencyStrategy;
	@Nullable
	...
	public <T> Callable<T> wrapCallable(Callable<T> callable) {
		Callable<T> wrapCallable = new HttpHeadersCallable<>(callable, accountGetter, properties);
		return existingConcurrencyStrategy != null
