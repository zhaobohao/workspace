...
import org.springclouddev.core.tool.convert.ClassTypeConversionService;
...
public class ConvertUtil {
	...
	public static <T> T convert(@Nullable Object source, Class<T> targetType) {
		...
		GenericConversionService conversionService = ClassTypeConversionService.getInstance();
