...
import org.springclouddev.crm.admin.api.bo.AdminDeleteByBatchIdBO;
import org.springclouddev.crm.admin.api.bo.RenameFileBO;
import org.springclouddev.crm.admin.api.entity.AdminFile;
import org.springclouddev.crm.admin.mapper.AdminFileMapper;
import org.springclouddev.crm.admin.service.IAdminFileService;
import org.springclouddev.crm.core.config.MybatisPlusConfig;
import org.springclouddev.crm.core.servlet.BaseServiceImpl;
import org.springclouddev.crm.core.servlet.upload.FileEntity;
import org.springclouddev.crm.core.servlet.upload.FileServiceFactory;
...
public class AdminFileServiceImpl extends BaseServiceImpl<AdminFileMapper, AdminFile> implements IAdminFileService {
    ...
    private void parseFileEntity(List<AdminFile> list, List<FileEntity> entityList) {
        list.forEach(adminFile -> {
            ...
            entity.setCreateUserName(UserCacheUtil.getUserName(adminFile.getCreateUser()));
            entity.setCreateUser(adminFile.getCreateUser());
