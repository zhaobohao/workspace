...
@Service
public class IntegralSubtraction extends AbstractFunction  implements MyFunction {
	...
	public AviatorObject call(Map<String, Object> env, AviatorObject arg1, AviatorObject arg2) {
		...
		return new AviatorString((Double.parseDouble(a1)-Double.parseDouble(a2))+"");
	}
	
	@Override
	public String getName() {
		return CommonCode.SUBTRACTION;
	}
