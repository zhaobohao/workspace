...
import org.springclouddev.iot.common.sdk.bean.DriverProperty;
...
import org.springclouddev.iot.manager.dto.*;
import org.springclouddev.iot.manager.entity.*;
import org.springclouddev.iot.manager.feign.*;
...
public class DriverCommonServiceImpl implements DriverCommonService {
    ...
    public void addProfile(Long id) {
        ...
        if (!r.isSuccess()) {
            log.error("Add profile failed {}", r.getMsg());
    ...
    public void addDevice(Long id) {
        ...
        if (!r.isSuccess()) {
            log.error("Add device failed {}", r.getMsg());
            throw new ServiceException(r.getMsg());
        }
    ...
    public void addPoint(Long pointId) {
        ...
        if (!r.isSuccess()) {
            log.error("Add point failed {}", r.getMsg());
            throw new ServiceException(r.getMsg());
        }
    ...
    public void addDriverInfo(Long id) {
        ...
        if (!r.isSuccess()) {
            log.error("Add driver info failed {}", r.getMsg());
            throw new ServiceException(r.getMsg());
        }
    ...
    public void addPointInfo(Long id) {
        ...
        if (!r.isSuccess()) {
            log.error("Add point info failed {}", r.getMsg());
            throw new ServiceException(r.getMsg());
        }
    ...
    public boolean registerDriver() {
        ...
        if (rDriver.isSuccess()) {
            if (null != rDriver.getData()) {
                ...
                return driverClient.update(driver).isSuccess();
            } else {
    ...
    public boolean registerDriverAttribute() {
        ...
        if (rDriverAttributes.isSuccess()) {
        ...
        for (String name : oldDriverAttributeMap.keySet()) {
            if (!newDriverAttributeMap.containsKey(name)) {
                ...
                if (rDriverInfo.isSuccess() && rDriverInfo.getData().getRecords().size() > 0) {
    ...
    public boolean registerPointAttribute() {
        ...
        for (String name : oldPointAttributeMap.keySet()) {
            if (!newPointAttributeMap.containsKey(name)) {
                ...
                if (rPointInfo.isSuccess() && rPointInfo.getData().getRecords().size() > 0) {
    ...
    public Map<Long, DriverAttribute> loadDriverAttributeMap(long driverId) {
        ...
        if (!rDriverAttribute.isSuccess()) {
            close();
            throw new ServiceException(rDriverAttribute.getMsg());
        }
    ...
    public Map<Long, PointAttribute> loadPointAttributeMap(long driverId) {
        ...
        if (!rPointAttribute.isSuccess()) {
            close();
            throw new ServiceException(rPointAttribute.getMsg());
        }
    ...
    public List<Long> loadProfile(long driverId) {
        ...
        if (!rp.isSuccess()) {
            close();
            throw new ServiceException(rp.getMsg());
        }
    ...
    public Map<String, AttributeInfo> getDriverInfoMap(Long profileId) {
        ...
        if (!rp.isSuccess()) {
            log.error("Get driver info map failed {}", rp.getMsg());
            return null;
        }
    ...
    public Map<Long, Map<String, AttributeInfo>> getPointInfoMap(Device device) {
        ...
        for (Long pointId : pointMap.keySet()) {
            ...
            if (!rp.isSuccess()) {
                log.error("Get point info map failed {}", rp.getMsg());
                return null;
            }
    ...
    public Map<Long, Point> getPointMap(Long profileId) {
        ...
        if (!rp.isSuccess()) {
            log.error("Get point map failed {}", rp.getMsg());
            return null;
        }
