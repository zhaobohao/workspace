...
CREATE TABLE `db_table_info`  (
  ...
  `db_instance_id` bigint(32) NULL DEFAULT NULL COMMENT '数据库id',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Dataway 中的API' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = 'Dataway API 发布历史。' ROW_FORMAT = Dynamic;
...
INSERT INTO `mk_dict` VALUES (1123598814738777220, 0, 'post_category', '-1', '岗位类型', 12, NULL, 0, 0);
INSERT INTO `mk_dict` VALUES (1123598814738777221, 1123598814738777220, 'post_category', '1', '高层', 1, NULL, 0, 0);
INSERT INTO `mk_dict` VALUES (1123598814738777222, 1123598814738777220, 'post_category', '2', '中层', 2, NULL, 0, 0);
INSERT INTO `mk_dict` VALUES (1123598814738777223, 1123598814738777220, 'post_category', '3', '基层', 3, NULL, 0, 0);
INSERT INTO `mk_dict` VALUES (1123598814738777224, 1123598814738777220, 'post_category', '4', '其他', 4, NULL, 0, 0);
...
INSERT INTO `mk_menu` VALUES (1260479111801892866, 0, '000000', 'drools', '规则引擎', 'drools', '/drools', 'dashboard', 11, 1, 0, 1, 'drools规则引擎菜单，配置相关的规则 。', 0, 1);
INSERT INTO `mk_menu` VALUES (1260479987539013634, 1260479111801892866, '000000', 'drools_group', '规则组', 'drools.group', 'drools/droolsgroup', 'table', 1, 1, 0, 1, '规则分组，在使用时，可以将一起执行的规则 分为一组，在验证的时候，一起执行。', 0, 0);
INSERT INTO `mk_menu` VALUES (1260481115857121281, 1260479111801892866, '000000', 'drools_droolsruls', '规则定义', 'drools.droolsruls', 'drools/droolsruls', 'tab', 2, 1, 0, 1, '详细定义规则 ，经编译后，可以被 正常调用执行。', 0, 0);
...
-- ----------------------------
INSERT INTO `mk_mock_http` VALUES (1252057126321303554, 1248162814462291970, 'test', '/findname', 'get', '{\"name\":\"naci\"}', '', '', '', 'utf-8', NULL, '', '', 'u name is :${name} is good for me ', '', 200, '接口访问成功', 0, '', '', '', '', '', '0', '', '', '', 1, '2020-04-20 10:10:56', -1, '2020-04-21 20:04:09', 0, 1, '000000');
INSERT INTO `mk_mock_http` VALUES (1252091455818768386, 1248162814462291970, 'test2', '/forward', 'get', '', '', '', '', 'utf-8', NULL, '', '', '', '', 200, '接口访问成功', 0, '127.0.0.1', '1080', '/hello', '', '', '0', '', '', '', 1, '2020-04-20 12:27:20', -1, '2020-04-20 12:37:32', 0, 1, '000000');
INSERT INTO `mk_mock_http` VALUES (1254726344099528706, 1248162814462291970, '贷款申请接口', '/apply', 'get', NULL, NULL, NULL, NULL, 'utf-8', 'ADCWhere.*', NULL, NULL, '{\"content\":\"u get new interface\"}', NULL, 200, '接口访问成功', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '2020-04-27 18:57:27', NULL, NULL, 0, 1, '000000');
...
-- ----------------------------
-- Table structure for mk_post
-- ----------------------------
DROP TABLE IF EXISTS `mk_post`;
CREATE TABLE `mk_post`  (
  `id` bigint(64) NOT NULL COMMENT '主键',
  `tenant_id` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT '000000' COMMENT '租户ID',
  `category` int(11) NULL DEFAULT NULL COMMENT '岗位类型',
  `post_code` varchar(12) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '岗位编号',
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '岗位描述',
  `create_user` bigint(64) NULL DEFAULT NULL COMMENT '创建人',
  `create_dept` bigint(64) NULL DEFAULT NULL COMMENT '创建部门',
...
-- Records of mk_post
-- ----------------------------
INSERT INTO `mk_post` VALUES (1123598817738675201, '000000', 1, 'ceo', '首席执行官', 1, '总经理', 1123598821738675201, 1123598813738675201, '2020-04-01 00:00:00', 1123598821738675201, '2020-04-01 00:00:00', 1, 0);
INSERT INTO `mk_post` VALUES (1123598817738675202, '000000', 1, 'coo', '首席运营官', 2, '常务总经理', 1123598821738675201, 1123598813738675201, '2020-04-01 00:00:00', 1123598821738675201, '2020-04-01 00:00:00', 1, 0);
INSERT INTO `mk_post` VALUES (1123598817738675203, '000000', 1, 'cfo', '首席财务官', 3, '财务总经理', 1123598821738675201, 1123598813738675201, '2020-04-01 00:00:00', 1123598821738675201, '2020-04-01 00:00:00', 1, 0);
INSERT INTO `mk_post` VALUES (1123598817738675204, '000000', 1, 'cto', '首席技术官', 4, '技术总监', 1123598821738675201, 1123598813738675201, '2020-04-01 00:00:00', 1123598821738675201, '2020-04-01 00:00:00', 1, 0);
INSERT INTO `mk_post` VALUES (1123598817738675205, '000000', 1, 'cio', '首席信息官', 5, '信息总监', 1123598821738675201, 1123598813738675201, '2020-04-01 00:00:00', 1123598821738675201, '2020-04-01 00:00:00', 1, 0);
INSERT INTO `mk_post` VALUES (1123598817738675206, '000000', 2, 'pm', '技术经理', 6, '研发和产品是永远的朋友', 1123598821738675201, 1123598813738675201, '2020-04-01 00:00:00', 1123598821738675201, '2020-04-01 00:00:00', 1, 0);
INSERT INTO `mk_post` VALUES (1123598817738675207, '000000', 2, 'hrm', '人力经理', 7, '人力资源部门工作管理者', 1123598821738675201, 1123598813738675201, '2020-04-01 00:00:00', 1123598821738675201, '2020-04-01 00:00:00', 1, 0);
INSERT INTO `mk_post` VALUES (1123598817738675208, '000000', 3, 'staff', '普通员工', 8, '普通员工', 1123598821738675201, 1123598813738675201, '2020-04-01 00:00:00', 1123598821738675201, '2020-04-01 00:00:00', 1, 0);
...
INSERT INTO `mk_role_menu` VALUES (1161272893875225001, 1164733389668962251, 1123598816738675201);
INSERT INTO `mk_role_menu` VALUES (1161272893875225002, 1164733389668962252, 1123598816738675201);
INSERT INTO `mk_role_menu` VALUES (1161272893875225003, 1164733389668962253, 1123598816738675201);
INSERT INTO `mk_role_menu` VALUES (1161272893875225004, 1164733389668962254, 1123598816738675201);
INSERT INTO `mk_role_menu` VALUES (1161272893875225005, 1164733389668962255, 1123598816738675201);
INSERT INTO `mk_role_menu` VALUES (1161272893875225006, 1164733389668962256, 1123598816738675201);
...
INSERT INTO `mk_role_menu` VALUES (1260482130308263937, 19, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130325041153, 20, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130350206977, 21, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130375372802, 22, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130400538625, 23, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130438287361, 24, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130476036098, 25, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130505396226, 26, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130534756353, 27, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130564116482, 28, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130593476609, 29, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130618642434, 30, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130643808258, 31, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130668974081, 32, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130694139905, 33, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130719305729, 34, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130736082946, 35, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130761248769, 36, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130790608897, 37, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130815774722, 38, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130845134849, 39, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130866106370, 40, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130891272194, 45, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130912243713, 46, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130929020929, 47, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130945798145, 48, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130966769665, 57, 1);
INSERT INTO `mk_role_menu` VALUES (1260482130991935489, 58, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131021295617, 59, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131046461442, 60, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131075821570, 62, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131100987394, 63, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131138736129, 64, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131172290561, 65, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131205844993, 90, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131235205121, 91, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131251982338, 92, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131281342466, 93, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131314896897, 11, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131340062722, 12, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131369422849, 49, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131394588673, 50, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131432337410, 51, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131453308930, 52, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131482669058, 53, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131503640578, 54, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131541389313, 55, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131570749441, 67, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131600109570, 68, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131625275394, 69, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131650441218, 70, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131688189953, 80, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131713355778, 81, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131742715905, 82, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131767881729, 83, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131801436162, 85, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131822407682, 86, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131843379201, 87, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131872739330, 88, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131897905153, 74, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131927265281, 75, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131960819714, 76, 1);
INSERT INTO `mk_role_menu` VALUES (1260482131994374145, 1164733389668962252, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132015345666, 1164733389668962253, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132040511490, 1164733389668962254, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132082454529, 1164733389668962255, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132103426050, 1218006949558280194, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132124397570, 1218048884088037378, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132145369089, 1218071066507796481, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132170534913, 1218074531384582145, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132195700737, 1218074984545574913, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132220866561, 1218076181276975105, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132241838082, 1218077454713806850, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132275392514, 1218078387258580994, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132292169729, 1247346011947466754, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132317335553, 1247346561095106561, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132338307074, 1260479987539013634, 1);
INSERT INTO `mk_role_menu` VALUES (1260482132376055810, 1260481115857121281, 1);
...
-- ----------------------------
INSERT INTO `mk_tenant` (1123598820738675201, '000000', '管理组', '', 'admin', '666666', '管理组', 1123598821738675201, '2019-01-01 00:00:39', 1123598821738675201, '2019-01-01 00:00:39', 1, 0);
COMMIT;
-- ----------------------------
