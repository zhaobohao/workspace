<template>
  <div id="vue-picture-viewer" :style="maskContainer">
    <!-- 头部 -->
    <flexbox class="perview-header">
      ...
      <img class="close" src="./img/pre_close.png" @click="closeViewer">
    </flexbox>
    <!-- 图片容器 -->
    <div ref="imgContainer" :style="imgContainer" class="imgContainer">
      <img v-if="bigShowType.isImage" ref="bigImg" :src="bigImgUrl" :style="bigImgStyle" alt="">
      <flexbox v-if="!bigShowType.isImage" class="file-show">
        <div class="file-icon">
        ...
        <div class="file-handle">
          ...
          <el-button type="primary" plain @click.native="fileHandle('download')">下载</el-button>
        </div>
      </flexbox>
      <!-- tips -->
    ...
    <div class="fixedHandle">
      ...
      <flexbox v-if="bigShowType.isImage" class="handleContainer">
        ...
        <img style="padding: 4.5px;" src="./img/pre_rotate.png" @click="rotate">
        <img src="./img/pre_down.png" @click="downloadImg(bigImgUrl, bigImgName)">
      </flexbox>
      <!-- 缩略图容器 -->
      <div v-if="imgLength > 1" class="thumbnailContainer">
        <ul>
          <li v-for="(item, index) in imgData" ref="thumbnailItem" :key="index" @click="switchImgUrl(index, $event)">
            <img v-if="isShowImage(item.url)" :src="item.url" alt="">
            <img v-if="!isShowImage(item.url)" :src="getFileTypeIconWithSuffix(item.url)" alt="">
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="leftArrowCon" @click="handlePrev" @mouseenter="enterLeft" @mouseout="outLeft">
      <img v-show="leftArrowShow" class="leftArrow" src="./img/pre_left.png" @click="enlarge">
    </div>
    <!-- 右边箭头 -->
    <div class="rightArrowCon" @click="handleNext" @mouseenter="enterRight" @mouseout="outRight">
      <img v-show="rightArrowShow" class="rightArrow" src="./img/pre_right.png">
    </div>
  </div>
</template>
