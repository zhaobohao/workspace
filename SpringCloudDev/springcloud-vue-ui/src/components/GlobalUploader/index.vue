      ...
      <uploader-list v-show="panelShow">
        <div class="file-panel" slot-scope="props" :class="{'collapse': collapse}">
          <div class="file-title">
            <h1>文件列表</h1>
            <div class="operate">
              <el-button @click="fileListShow" type="success" circle :icon="collapse ? 'el-icon-edit':'el-icon-check' ">
              </el-button>
              <el-button @click="close" type="danger" circle icon="el-icon-delete">
              </el-button>
            </div>
          </div>
...
<script>
  ...
  export default {
    data() {
      return {
        options: {
          target: process.env.VUE_APP_BASE_API + '/springcloud-develop/tableinfo/uploadExcel',
          chunkSize: '2048000',
          ...
          headers: {
            ...
            'springcloud-auth': 'bearer ' + getToken()
          },
          query() {}
        },
        attrs: {
