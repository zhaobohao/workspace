<template>
  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-form-item label="集合码" prop="code">
      ...
      <el-form-item label="描述" prop="glDesc">
        <el-input v-model="temp.glDesc" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="集合类别" prop="sort">
        <el-input v-model="temp.sort" style="width: 305px;" />
      </el-form-item>
