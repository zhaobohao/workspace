  ...
  <el-card>
    ...
    <el-table :key="tableKey" ref="messageTable" v-loading="listLoading" :data="list" :height="tableHeight"
      ...
      <el-table-column label="编号" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.grpListId }}</span>
        </template>
      </el-table-column>
      <el-table-column label="集合码" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.code }}</span>
        </template>
      </el-table-column>
      <el-table-column label="集合名称" min-width="150px">
        <template slot-scope="scope">
      ...
      <el-table-column label="描述" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.glDesc }}</span>
        </template>
      </el-table-column>
      <el-table-column label="集合类别" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.sort }}</span>
        </template>
      </el-table-column>
      <el-table-column label="集合类型" min-width="150px">
        <template slot-scope="scope">
