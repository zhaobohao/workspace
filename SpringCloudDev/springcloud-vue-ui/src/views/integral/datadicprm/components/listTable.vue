  ...
  <el-card>
    ...
    <el-table :key="tableKey" ref="messageTable" v-loading="listLoading" :data="list" :height="tableHeight"
      ...
      <el-table-column label="编号" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.dataDicPrmId }}</span>
        </template>
      </el-table-column>
      <el-table-column label="参数编号" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.code }}</span>
        </template>
      </el-table-column>
      <el-table-column label="父级菜单" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.parentId }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="参数描述" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.ddDesc }}</span>
        </template>
      </el-table-column>
      <el-table-column label="参数类别" min-width="150px">
        <template slot-scope="scope">
      ...
      <el-table-column label="是否是叶子节点，0是，1不是" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.isLeaf }}</span>
        </template>
      </el-table-column>
