<template>
  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-form-item label="交易积分" prop="changeIntegral">
        <el-input v-model="temp.changeIntegral" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="交易日期" prop="changeDate">
        <el-input v-model="temp.changeDate" style="width: 305px;" />
      </el-form-item>
      ...
      <el-form-item label="业务" prop="business">
        <el-input v-model="temp.business" style="width: 305px;" />
      </el-form-item>
...
<script>
  ...
  // 引入相应的工具来处理数据转换需求
  import listQuery from '@/entitys/accountintegraldetail'
  // 引入相关utils
  import notify from '@/utils/notify'
  import elDragDialog from '@/directive/el-drag-dialog' // base on element-ui
  export default {
    // TODO:本页面的名称
    name: 'accountintegraldetail-dataForm',
    components: {
