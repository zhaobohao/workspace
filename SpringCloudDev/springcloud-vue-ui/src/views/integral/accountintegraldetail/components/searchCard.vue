  ...
  <el-card v-show="isSearchCardShow" style="margin-bottom: 20px">
    ...
    <div class="filter-container">
      <!--具体的查询条件，使用placeholder来显示标题-->
        <el-input-number v-model="temp.accountIntegralDetailId" placeholder="自增主键" :precision="0" :step="1" :max="100" style="width: 305px;" />
      ...
      <el-input v-model="listQuery.query.identyCard" placeholder="证件号码" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.changeIntegral" placeholder="交易积分" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.changeDate" placeholder="交易日期" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      ...
      <el-input v-model="listQuery.query.accountBlance" placeholder="账户余额" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.business" placeholder="业务" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.remark" placeholder="描述" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
...
<script>
  ...
  export default {
    // TODO:本页面的名称
    name: 'accountintegraldetail-searchCard',
    directives: {
      waves
    },
    props: {
