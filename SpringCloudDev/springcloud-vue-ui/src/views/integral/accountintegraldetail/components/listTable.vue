<template>
  <el-card>
    ...
    <el-table :key="tableKey" ref="messageTable" v-loading="listLoading" :data="list" :height="tableHeight"
      ...
      <el-table-column label="自增主键" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.accountIntegralDetailId }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="交易积分" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.changeIntegral }}</span>
        </template>
      </el-table-column>
      <el-table-column label="交易日期" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.changeDate }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="业务" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.business }}</span>
        </template>
      </el-table-column>
...
<script>
  ...
  import {
    getList,
    remove
  } from '@/api/system/accountintegraldetail'
  // 按钮的水波纹
  ...
  export default {
    // TODO:本页面的名称
    name: 'accountintegraldetail-listTable',
    components: {
      Pagination
    },
    directives: {
