  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-form-item label="调整数量" prop="adjustNum">
        <el-input v-model="temp.adjustNum" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="调整状态id" prop="statusValue">
        <el-input v-model="temp.statusValue" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="调整状态name" prop="statusName">
        <el-input v-model="temp.statusName" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="调整人" prop="crtUser">
      ...
      <el-form-item label="最后更新时间" prop="lstUpdTime">
        <el-input v-model="temp.lstUpdTime" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="调整日期" prop="adjustDate">
        <el-input v-model="temp.adjustDate" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="调整原因" prop="adjustReason">
        <el-input v-model="temp.adjustReason" style="width: 305px;" />
      </el-form-item>
...
<script>
  ...
  export default {
    // TODO:本页面的名称
    name: 'integraladjustaction-dataForm',
    components: {
