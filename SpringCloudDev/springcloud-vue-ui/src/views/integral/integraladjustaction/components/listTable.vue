  ...
  <el-card>
    ...
    <el-table :key="tableKey" ref="messageTable" v-loading="listLoading" :data="list" :height="tableHeight"
      ...
      <el-table-column label="自增主键" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.integralAdjustActionId }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="调整数量" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.adjustNum }}</span>
        </template>
      </el-table-column>
      <el-table-column label="调整状态id" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.statusValue }}</span>
        </template>
      </el-table-column>
      <el-table-column label="调整状态name" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.statusName }}</span>
        </template>
      </el-table-column>
      <el-table-column label="调整人" min-width="150px">
        <template slot-scope="scope">
      ...
      <el-table-column label="调整日期" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.adjustDate }}</span>
        </template>
      </el-table-column>
      <el-table-column label="调整原因" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.adjustReason }}</span>
        </template>
      </el-table-column>
...
<script>
  ...
  import {
    getList,
    remove
  } from '@/api/system/integraladjustaction'
  // 按钮的水波纹
  ...
  export default {
    // TODO:本页面的名称
    name: 'integraladjustaction-listTable',
    components: {
      Pagination
    },
    directives: {
