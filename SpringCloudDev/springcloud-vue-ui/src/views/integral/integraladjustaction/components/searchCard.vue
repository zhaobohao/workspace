  ...
  <el-card v-show="isSearchCardShow" style="margin-bottom: 20px">
    ...
    <div class="filter-container">
      <!--具体的查询条件，使用placeholder来显示标题-->
        <el-input-number v-model="temp.integralAdjustActionId" placeholder="自增主键" :precision="0" :step="1" :max="100" style="width: 305px;" />
      ...
      <el-input v-model="listQuery.query.custId" placeholder="客户编号" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.adjustNum" placeholder="调整数量" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.statusValue" placeholder="调整状态id" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.statusName" placeholder="调整状态name" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.crtUser" placeholder="调整人" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      ...
      <el-input v-model="listQuery.query.lstUpdUser" placeholder="最后更新人" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.lstUpdTime" placeholder="最后更新时间" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.adjustDate" placeholder="调整日期" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.adjustReason" placeholder="调整原因" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
...
<script>
  ...
  import listQuery from '@/entitys/integraladjustaction'
  // 按钮的水波纹
  import waves from '@/directive/waves' // Waves directive
  // model 文件
  export default {
    // TODO:本页面的名称
    name: 'integraladjustaction-searchCard',
    directives: {
      waves
    },
    props: {
