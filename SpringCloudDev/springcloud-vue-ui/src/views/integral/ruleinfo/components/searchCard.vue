  ...
  <el-card v-show="isSearchCardShow" style="margin-bottom: 20px">
    ...
    <div class="filter-container">
      <!--具体的查询条件，使用placeholder来显示标题-->
        <el-input-number v-model="temp.ruleId" placeholder="规则编号" :precision="0" :step="1" :max="100" style="width: 305px;" />
      <el-input v-model="listQuery.query.ruleName" placeholder="规则名称" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.ruleStatus" placeholder="规则状态" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.ruleExp" placeholder="" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      ...
      <el-input v-model="listQuery.query.crtUser" placeholder="创建人" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.crtDate" placeholder="创建日期" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.lstUpdUser" placeholder="送审人" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.lstUpdTime" placeholder="送审日期" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
...
<script>
  ...
  import listQuery from '@/entitys/ruleinfo'
  // 按钮的水波纹
  import waves from '@/directive/waves' // Waves directive
  // model 文件
  export default {
    // TODO:本页面的名称
    name: 'ruleinfo-searchCard',
    directives: {
      waves
    },
    props: {
