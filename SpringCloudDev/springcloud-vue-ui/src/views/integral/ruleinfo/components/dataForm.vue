  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-form-item label="规则名称" prop="ruleName">
        <el-input v-model="temp.ruleName" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="规则状态" prop="ruleStatus">
        <el-input v-model="temp.ruleStatus" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="" prop="ruleExp">
        <el-input v-model="temp.ruleExp" style="width: 305px;" />
      </el-form-item>
      ...
      <el-form-item label="创建日期" prop="crtDate">
        <el-input v-model="temp.crtDate" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="送审人" prop="lstUpdUser">
        <el-input v-model="temp.lstUpdUser" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="送审日期" prop="lstUpdTime">
