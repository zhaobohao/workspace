  ...
  <el-card v-show="isSearchCardShow" style="margin-bottom: 20px">
    ...
    <div class="filter-container">
      <!--具体的查询条件，使用placeholder来显示标题-->
        <el-input-number v-model="temp.groupId" placeholder="组群编号" :precision="0" :step="1" :max="100" style="width: 305px;" />
        <el-input-number v-model="temp.groupNm" placeholder="组群号码" :precision="0" :step="1" :max="100" style="width: 305px;" />
