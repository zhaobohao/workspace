<template>
  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    ...
    <el-form-item label="组群号码" prop="groupNm">
        <el-input-number v-model="temp.groupNm" :precision="0" :step="1" :max="100" style="width: 305px;" />
    </el-form-item>
      <el-form-item label="组群名称" prop="groupName">
        <el-input v-model="temp.groupName" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="组群描述" prop="groupDesc">
        <el-input v-model="temp.groupDesc" style="width: 305px;" />
      </el-form-item>
