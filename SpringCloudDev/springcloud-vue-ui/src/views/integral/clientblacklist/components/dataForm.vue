<template>
  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    ...
    <el-form-item label="规则名称" prop="clientId">
        <el-input-number v-model="temp.clientId" :precision="0" :step="1" :max="100" style="width: 305px;" />
    </el-form-item>
      <el-form-item label="客户姓名" prop="clientName">
        <el-input v-model="temp.clientName" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="开户行名称" prop="bankName">
        <el-input v-model="temp.bankName" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="性别" prop="sex">
        <el-input v-model="temp.sex" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="联系电话" prop="mobile">
        <el-input v-model="temp.mobile" style="width: 305px;" />
      </el-form-item>
