...
<template>
  <el-card v-show="isSearchCardShow" style="margin-bottom: 20px">
    ...
    <div class="filter-container">
      ...
      <el-input-number v-model="temp.blackId" placeholder="黑名单编号" :precision="0" :step="1" :max="100"
        style="width: 305px;" />
      <el-input-number v-model="temp.clientId" placeholder="规则名称" :precision="0" :step="1" :max="100"
        style="width: 305px;" />
