  ...
  <el-card v-show="isSearchCardShow" style="margin-bottom: 20px">
    ...
    <div class="filter-container">
      <!--具体的查询条件，使用placeholder来显示标题-->
        <el-input-number v-model="temp.blackId" placeholder="黑名单编号" :precision="0" :step="1" :max="100" style="width: 305px;" />
        <el-input-number v-model="temp.clientId" placeholder="规则名称" :precision="0" :step="1" :max="100" style="width: 305px;" />
      <el-input v-model="listQuery.query.clientName" placeholder="客户姓名" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.bankName" placeholder="开户行名称" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.sex" placeholder="性别" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.mobile" placeholder="联系电话" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
...
<script>
  ...
  import listQuery from '@/entitys/clientblacklist'
  // 按钮的水波纹
  import waves from '@/directive/waves' // Waves directive
  // model 文件
  export default {
    // TODO:本页面的名称
    name: 'clientblacklist-searchCard',
    directives: {
      waves
    },
    props: {
