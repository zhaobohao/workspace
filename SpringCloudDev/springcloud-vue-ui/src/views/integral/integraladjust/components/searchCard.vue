  ...
  <el-card v-show="isSearchCardShow" style="margin-bottom: 20px">
    ...
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.query.custId" placeholder="客户编号" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.adjustType" placeholder="调整类型" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      ...
      <el-input v-model="listQuery.query.crtUser" placeholder="调整人" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.crtTime" placeholder="调整日期" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
...
<script>
  ...
  import listQuery from '@/entitys/integraladjust'
  // 按钮的水波纹
  import waves from '@/directive/waves' // Waves directive
  // model 文件
  export default {
    // TODO:本页面的名称
    name: 'integraladjust-searchCard',
    directives: {
      waves
    },
    props: {
