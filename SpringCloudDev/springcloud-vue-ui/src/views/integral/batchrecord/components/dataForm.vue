<template>
  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-form-item label="批量所属类型" prop="batchType">
        <el-input v-model="temp.batchType" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="批量描述" prop="batchDesc">
        <el-input v-model="temp.batchDesc" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="批量数量" prop="batchNm">
        <el-input-number v-model="temp.batchNm" :precision="0" :step="1" :max="100" style="width: 305px;" />
      </el-form-item>
