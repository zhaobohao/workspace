<template>
  <el-card>
    ...
    <el-table :key="tableKey" ref="messageTable" v-loading="listLoading" :data="list" :height="tableHeight"
      ...
      <el-table-column label="表达式" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.expId }}</span>
        </template>
      </el-table-column>
      <el-table-column label="MCC码" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.mccId }}</span>
        </template>
      </el-table-column>
      <el-table-column label="名单码" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.nameId }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="更新时间" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.updTime }}</span>
        </template>
      </el-table-column>
      <el-table-column label="更新人" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.updUser }}</span>
        </template>
      </el-table-column>
      <el-table-column label="" min-width="150px">
        <template slot-scope="scope">
      ...
      <el-table-column label="" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.params }}</span>
        </template>
      </el-table-column>
