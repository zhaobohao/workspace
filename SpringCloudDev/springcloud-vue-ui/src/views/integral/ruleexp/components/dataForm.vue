<template>
  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-form-item label="表达式" prop="expId">
        <el-input v-model="temp.expId" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="MCC码" prop="mccId">
        <el-input v-model="temp.mccId" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="名单码" prop="nameId">
        <el-input v-model="temp.nameId" style="width: 305px;" />
      </el-form-item>
      ...
      <el-form-item label="更新时间" prop="updTime">
        <el-date-picker v-model="temp.updTime" type="datetime" placeholder="选择日期时间" align="right"
          :picker-options="pickerOptions">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="更新人" prop="updUser">
        <el-input v-model="temp.updUser" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="" prop="version">
        <el-input v-model="temp.version" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="" prop="params">
        <el-input v-model="temp.params" style="width: 305px;" />
      </el-form-item>
    </el-form>
