<template>
  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-form-item label="" prop="actCode">
        <el-input v-model="temp.actCode" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="" prop="ruleId">
        <el-input-number v-model="temp.ruleId" :precision="0" :step="1" :max="100" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="规则计算类型 " prop="type">
        <el-input v-model="temp.type" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="优先级" prop="grade">
        <el-input v-model="temp.grade" style="width: 305px;" />
      </el-form-item>
