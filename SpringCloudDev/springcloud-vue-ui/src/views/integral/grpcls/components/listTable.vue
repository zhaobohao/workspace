  ...
  <el-card>
    ...
    <el-table :key="tableKey" ref="messageTable" v-loading="listLoading" :data="list" :height="tableHeight"
      ...
      <el-table-column label="编号" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.grpClsId }}</span>
        </template>
      </el-table-column>
      <el-table-column label="" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.listId }}</span>
        </template>
      </el-table-column>
      <el-table-column label="组群码" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.code }}</span>
        </template>
      </el-table-column>
      <el-table-column label="组群名称" min-width="150px">
        <template slot-scope="scope">
      ...
      <el-table-column label="描述" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.gcDesc }}</span>
        </template>
      </el-table-column>
      <el-table-column label="组群类别" min-width="150px">
        <template slot-scope="scope">
