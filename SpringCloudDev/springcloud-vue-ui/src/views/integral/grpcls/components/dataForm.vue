<template>
  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-form-item label="" prop="listId">
        <el-input v-model="temp.listId" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="组群码" prop="code">
        <el-input v-model="temp.code" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="组群名称" prop="name">
        <el-input v-model="temp.name" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="描述" prop="gcDesc">
        <el-input v-model="temp.gcDesc" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="组群类别" prop="type">
...
<script>
  ...
  // 引入相应的工具来处理数据转换需求
  import listQuery from '@/entitys/grpcls'
  // 引入相关utils
  import notify from '@/utils/notify'
  import elDragDialog from '@/directive/el-drag-dialog' // base on element-ui
  export default {
    // TODO:本页面的名称
    name: 'grpcls-dataForm',
    components: {
