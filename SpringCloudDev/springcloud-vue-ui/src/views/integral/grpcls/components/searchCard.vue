  ...
  <el-card v-show="isSearchCardShow" style="margin-bottom: 20px">
    ...
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.query.code" placeholder="组群码" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.name" placeholder="组群名称" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.gcDesc" placeholder="描述" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.type" placeholder="组群类别" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
