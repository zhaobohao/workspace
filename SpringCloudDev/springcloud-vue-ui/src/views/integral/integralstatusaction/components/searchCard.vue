  ...
  <el-card v-show="isSearchCardShow" style="margin-bottom: 20px">
    ...
    <div class="filter-container">
      <!--具体的查询条件，使用placeholder来显示标题-->
        <el-input-number v-model="temp.integralStatusActionId" placeholder="自增主键" :precision="0" :step="1" :max="100" style="width: 305px;" />
      ...
      <el-input v-model="listQuery.query.custId" placeholder="客户编号" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.custName" placeholder="客户名称" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.integralType" placeholder="积分类型" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.blance" placeholder="当前余额" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.operationType" placeholder="操作" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.rejectReason" placeholder="退回原因" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.accountStatusId" placeholder="状态id" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.accountStatus" placeholder="状态" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
...
<script>
  ...
  import listQuery from '@/entitys/integralstatusaction'
  // 按钮的水波纹
  import waves from '@/directive/waves' // Waves directive
  // model 文件
  export default {
    // TODO:本页面的名称
    name: 'integralstatusaction-searchCard',
    directives: {
      waves
    },
    props: {
