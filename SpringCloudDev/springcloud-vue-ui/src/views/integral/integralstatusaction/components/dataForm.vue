<template>
  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-form-item label="当前余额" prop="blance">
        <el-input v-model="temp.blance" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="操作" prop="operationType">
        <el-input v-model="temp.operationType" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="退回原因" prop="rejectReason">
        <el-input v-model="temp.rejectReason" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="状态id" prop="accountStatusId">
...
<script>
  ...
  export default {
    // TODO:本页面的名称
    name: 'integralstatusaction-dataForm',
    components: {
