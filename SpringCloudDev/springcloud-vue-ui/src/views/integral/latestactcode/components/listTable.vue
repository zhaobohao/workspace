<template>
  <el-card>
    ...
    <el-table :key="tableKey" ref="messageTable" v-loading="listLoading" :data="list" :height="tableHeight"
      ...
      <el-table-column label="活动codeid" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.actCodeId }}</span>
        </template>
      </el-table-column>
      <el-table-column label="活动编号前缀" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.prefixActCode }}</span>
        </template>
      </el-table-column>
      <el-table-column label="活动编号后缀" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.suffixActCode }}</span>
        </template>
      </el-table-column>
