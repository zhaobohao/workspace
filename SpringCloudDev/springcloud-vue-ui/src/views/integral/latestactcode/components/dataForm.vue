<template>
  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-form-item label="活动编号前缀" prop="prefixActCode">
        <el-input v-model="temp.prefixActCode" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="活动编号后缀" prop="suffixActCode">
        <el-input v-model="temp.suffixActCode" style="width: 305px;" />
      </el-form-item>
    </el-form>
