  ...
  <el-card>
    ...
    <el-table :key="tableKey" ref="messageTable" v-loading="listLoading" :data="list" :height="tableHeight"
      ...
      <el-table-column label="表id编号" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.actPrmCateId }}</span>
        </template>
      </el-table-column>
      <el-table-column label="所属活动类别编号" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.apCode }}</span>
        </template>
      </el-table-column>
      <el-table-column label="类别项类别编号" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.code }}</span>
        </template>
      </el-table-column>
      <el-table-column label="类别项类别名称" min-width="150px">
        <template slot-scope="scope">
      ...
      <el-table-column label="备注" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.apcDesc }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="显示顺序" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.apOrder }}</span>
        </template>
      </el-table-column>
