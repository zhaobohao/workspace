<template>
  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-form-item label="所属活动类别编号" prop="apCode">
        <el-input v-model="temp.apCode" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="类别项类别编号" prop="code">
        <el-input v-model="temp.code" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="类别项类别名称" prop="name">
        <el-input v-model="temp.name" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="备注" prop="apcDesc">
        <el-input v-model="temp.apcDesc" style="width: 305px;" />
      </el-form-item>
