  ...
  <el-card v-show="isSearchCardShow" style="margin-bottom: 20px">
    ...
    <div class="filter-container">
      <!--具体的查询条件，使用placeholder来显示标题-->
        <el-input-number v-model="temp.actPrmCateId" placeholder="表id编号" :precision="0" :step="1" :max="100" style="width: 305px;" />
      ...
      <el-input v-model="listQuery.query.reserveCokumn3" placeholder="预留字段3" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
        <el-input-number v-model="temp.apOrder" placeholder="显示顺序" :precision="0" :step="1" :max="100" style="width: 305px;" />
