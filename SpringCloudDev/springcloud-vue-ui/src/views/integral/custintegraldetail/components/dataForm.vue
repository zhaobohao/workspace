  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-form-item label="客户姓名" prop="custName">
        <el-input v-model="temp.custName" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="证件类型" prop="identyType">
        <el-input v-model="temp.identyType" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="证件号码" prop="identyCard">
        <el-input v-model="temp.identyCard" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="客户电话" prop="phoneNum">
        <el-input v-model="temp.phoneNum" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="客户地址" prop="custAddress">
        <el-input v-model="temp.custAddress" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="积分类型" prop="integralType">
        <el-input v-model="temp.integralType" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="积分类型ID" prop="integralTypeId">
        <el-input v-model="temp.integralTypeId" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="积分有效期" prop="integralValidDate">
        <el-input v-model="temp.integralValidDate" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="积分有效期余额" prop="integralValidBlance">
        <el-input v-model="temp.integralValidBlance" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="账户余额" prop="accountBlance">
        <el-input v-model="temp.accountBlance" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="已使用总额" prop="usedToatl">
        <el-input v-model="temp.usedToatl" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="账户状态" prop="accountStatus">
        <el-input v-model="temp.accountStatus" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="账户状态ID" prop="accountStatusId">
        <el-input v-model="temp.accountStatusId" style="width: 305px;" />
      </el-form-item>
...
<script>
  ...
  export default {
    // TODO:本页面的名称
    name: 'custintegraldetail-dataForm',
    components: {
