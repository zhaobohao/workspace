  ...
  <el-card v-show="isSearchCardShow" style="margin-bottom: 20px">
    ...
    <div class="filter-container">
      <!--具体的查询条件，使用placeholder来显示标题-->
        <el-input-number v-model="temp.integralStatusId" placeholder="自增主键" :precision="0" :step="1" :max="100" style="width: 305px;" />
      ...
      <el-input v-model="listQuery.query.custId" placeholder="客户编号" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.statusValue" placeholder="调整状态" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
...
<script>
  ...
  export default {
    // TODO:本页面的名称
    name: 'integralstatus-searchCard',
    directives: {
      waves
    },
    props: {
