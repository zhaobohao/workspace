  ...
  <el-card>
    ...
    <el-table :key="tableKey" ref="messageTable" v-loading="listLoading" :data="list" :height="tableHeight"
      ...
      <el-table-column label="自增主键" min-width="150px">
        <template slot-scope="scope">
          <span class="link-type" click="handleUpdate(scope.row)">{{ scope.row.integralStatusId }}</span>
        </template>
      </el-table-column>
      ...
      <el-table-column label="调整状态" min-width="150px">
        <template slot-scope="scope">
