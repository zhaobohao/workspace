...
<style lang="scss" scoped>
  ...
  .login-container {
    ...
    .animation1 {
      ...
      animation: slashStar 4s ease-in-out .3s infinite;
    }
    ...
    .animation3 {
      left: 53%;
      top: 20%;
      animation: slashStar 1s ease-in-out .5s infinite;
    }

    .animation4 {
      left: 72%;
      top: 64%;
      background-color: #e4132f;
      animation: slashStar 6s ease-in-out .8s infinite;
    }

    .animation5 {
      left: 87%;
      top: 30%;
      animation: slashStar 3s ease-in-out 1.5s infinite;
    }
