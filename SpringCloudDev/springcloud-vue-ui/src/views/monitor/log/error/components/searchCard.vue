...
<template>
  <el-card v-show="isSearchCardShow" style="margin-bottom: 20px">
    ...
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.query.serviceId" placeholder="服务id" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.serverHost" placeholder="服务host" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
...
<script>
  ...
  import listQuery from '@/entitys/log'
  // 按钮的水波纹
