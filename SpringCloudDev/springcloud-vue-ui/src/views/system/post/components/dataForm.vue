  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-form-item label="岗位类型" prop="category">
        <el-tooltip class="item" effect="dark" content="岗位类型" placement="top">
          <el-select v-model="temp.category" filterable :placeholder="$t('table.pleaseSelect')" style="width: 305px;">
            <el-option v-for="item in postOptions" :key="item.dictKey" :label="item.dictValue" :value="item.dictKey">
            </el-option>
          </el-select>
        </el-tooltip>
      </el-form-item>
      <el-form-item label="岗位编号" prop="postCode">
        <el-tooltip class="item" effect="dark" content="岗位编号" placement="top">
          <el-input v-model="temp.postCode" style="width: 305px;" />
        </el-tooltip>
      </el-form-item>
      <el-form-item label="岗位名称" prop="postName">
        <el-tooltip class="item" effect="dark" content="岗位名称" placement="top">
          <el-input v-model="temp.postName" style="width: 305px;" />
        </el-tooltip>
      </el-form-item>
      <el-form-item label="岗位排序" prop="sort">
        <el-tooltip class="item" effect="dark" content="岗位排序" placement="top">
          <el-input-number v-model="temp.sort" :precision="0" :step="1" :max="100" style="width: 305px;" />
        </el-tooltip>
      </el-form-item>
      <el-form-item label="岗位描述" prop="remark">
        <el-tooltip class="item" effect="dark" content="岗位描述" placement="top">
