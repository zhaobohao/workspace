...
<template>
  <el-card v-show="isSearchCardShow" style="margin-bottom: 20px">
    ...
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.query.account" placeholder="登录账号" style="width: 200px;"
  ...
  export default {
    ...
    methods: {
      resetListQuery() {
        ...
        this.listQuery.query.deptId_equal = this.$parent.$parent.$parent.$parent.$refs.listTable.listQuery.query
          .deptId_equal
