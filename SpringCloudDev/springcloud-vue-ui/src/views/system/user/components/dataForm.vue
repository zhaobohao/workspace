<template>
  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    ...
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-row type="flex" class="row-bg">
        <el-col :span="12">
          <el-form-item label="登录账号" prop="account">
            <el-input v-model="temp.account" style="width: 305px;" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row v-if="dialogStatus==='create'" type="flex" class="row-bg">
        <el-col :span="12">
        ...
        <el-col :span="12">
          <el-form-item label="确认密码" prop="password2">
            <el-input v-model="temp.password2" style="width: 305px;" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row type="flex" class="row-bg">
        ...
        <el-col :span="12">
          <el-form-item label="所属部门" prop="deptId">
            <el-cascader v-model="deptParentIds" :show-all-levels="true" :options="deptOptions" :props="props"
              :clearable="true" filterable style="width:305px;" @change="handleDeptIdItemChange"></el-cascader>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row type="flex" class="row-bg">
        ...
        <el-col :span="12">
          <el-form-item label="用户姓名" prop="realName">
            <el-input v-model="temp.realName" style="width: 305px;" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row type="flex" class="row-bg">
        <el-col :span="12">
          <el-form-item label="手机号码" prop="phone">
            <el-input v-model="temp.phone" style="width: 305px;" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="电子邮箱" prop="email">
            <el-input v-model="temp.email" style="width: 305px;" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row type="flex" class="row-bg">
        <el-col :span="12">
          <el-form-item label="用户性别" prop="sex">
            <el-select v-model="temp.sex" filterable :placeholder="$t('table.pleaseSelect')" style="width: 305px;">
              <el-option v-for="item in sexOptions" :key="item.dictKey" :label="item.dictValue" :value="item.dictKey">
              </el-option>
            </el-select>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="用户生日" prop="birthday">
            <el-date-picker v-model="temp.birthday" type="datetime" format="yyyy-MM-dd HH:mm:ss"
              value-format="yyyy-MM-dd HH:mm:ss" placeholder="Select date and time" style="width: 305px;" />
          </el-form-item>
        </el-col>
      </el-row>
      <br />
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.rules.password[0].validator = this.validatePass
      this.rules.password2[0].validator = this.validatePass2
    },
    mounted() {
      window.onresize = () => {
        return (() => {
    ...
    methods: {
      ...
      handleRoleIdItemChange(val) {
        // val为选中项的id数组
        // console.log(val)
        this.temp.roleId = val.toString()
      },
      handleDeptIdItemChange(val) {
        // val为选中项的id数组
        // console.log(val)
        this.temp.deptId = val.toString()
      },
      setDialogWidth() {
