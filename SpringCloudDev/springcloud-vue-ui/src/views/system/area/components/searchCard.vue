...
<template>
  <el-card v-show="isSearchCardShow" style="margin-bottom: 20px">
    ...
    <div class="filter-container">
      ...
      <el-input v-model="listQuery.query.areaCode" placeholder="区域编码" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
      <el-input v-model="listQuery.query.areaName" placeholder="区域名称" style="width: 200px;"
        @keyup.enter.native="handleFilter" />
