  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-row type="flex" class="row-bg">
        <el-col :span="12">
          <el-form-item label="区域名称" prop="areaName">
            <el-input v-model="temp.areaName" style="width: 305px;" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="区域类型" prop="areaType">
            <el-select v-model="temp.areaType" :placeholder="$t('table.pleaseSelect')" class="filter-item"
              style="width: 305px;">
              <el-option v-for="item in areatypeOptions" :key="item.dictKey" :label="item.dictValue"
                :value="item.dictKey" />
            </el-select>
          </el-form-item>
        </el-col>
      ...
      <el-row type="flex" class="row-bg">
        <el-col :span="12">
          <el-form-item label="区域编码" prop="areaCode">
            <el-input v-model="temp.areaCode" style="width: 305px;" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-form-item label="备注信息" prop="remarks">
        <el-input v-model="temp.remarks" type="textarea" style="width: 815px;" />
      </el-form-item>
      <br />
    </el-form>
