<template>
  ...
  <el-dialog v-el-drag-dialog :width="dialogWidth" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
    <el-form ref="dataForm" :inline="true" :rules="rules" :model="temp" label-position="left" label-width="120px"
      ...
      <el-form-item label="data账号" prop="dataUser">
        <el-input v-model="temp.dataUser" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="etl账号" prop="etlUser">
        <el-input v-model="temp.etlUser" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="opr账号" prop="oprUser">
        <el-input v-model="temp.oprUser" style="width: 305px;" />
      </el-form-item>
      <el-form-item label="rpt账号" prop="rptUser">
        <el-input v-model="temp.rptUser" style="width: 305px;" />
      </el-form-item>
    </el-form>
...
<script>
  ...
  // 引入相应的工具来处理数据转换需求
  import listQuery from '@/entitys/dbinstance'
  // 引入相关utils
  import notify from '@/utils/notify'
  import elDragDialog from '@/directive/el-drag-dialog' // base on element-ui
  export default {
    // TODO:本页面的名称
    name: 'dbinstance-dataForm',
    components: {
