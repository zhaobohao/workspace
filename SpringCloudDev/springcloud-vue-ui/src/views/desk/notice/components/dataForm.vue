      ...
      <el-row type="flex" class="row-bg">
        <el-col :span="12">
          <el-form-item label="通知标题" prop="title">
            <el-input v-model="temp.title" style="width: 305px;" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="通知类型" prop="category">
            <el-select v-model="temp.category" :placeholder="$t('table.pleaseSelect')" class="filter-item">
      ...
      <el-row type="flex" class="row-bg">
        <el-col :span="12">
          <el-form-item label="通知日期" prop="releaseTime">
            <el-date-picker v-model="temp.releaseTime" type="datetime" placeholder="通知日期" align="right"
              :picker-options="pickerOptions" style="width: 305px;">
            </el-date-picker>
          </el-form-item>
        </el-col>
      </el-row>
