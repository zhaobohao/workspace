...
public class DependWrapper {
    private ServiceInstance<?, ?> dependWrapper;
    /**
     * 是否该依赖必须完成后才能执行自己.<p>
    ...
    public DependWrapper(ServiceInstance<?, ?> dependWrapper, boolean must) {
    ...
    public ServiceInstance<?, ?> getDependWrapper() {
        return dependWrapper;
    }

    public void setDependWrapper(ServiceInstance<?, ?> dependWrapper) {
        this.dependWrapper = dependWrapper;
    }
