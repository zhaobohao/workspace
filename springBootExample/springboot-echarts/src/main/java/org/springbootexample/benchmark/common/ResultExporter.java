package org.springbootexample.benchmark.common;

import org.openjdk.jmh.infra.BenchmarkParams;
import org.openjdk.jmh.results.BenchmarkResult;
import org.openjdk.jmh.results.Result;
import org.openjdk.jmh.results.RunResult;
import org.springbootexample.echarts.common.util.ExportPngUtil;
...
public class ResultExporter {
    ...
    public static void exportResult(String titleStr, Collection<RunResult> results,
        ...
        String optionStr = ExportPngUtil.generateOption(titleStr, objects, dimensions, allData, xunit);
        // POST到接口上
        ExportPngUtil.postOption(optionStr, "http://localhost:9075/api/v1/data");
    }
}
