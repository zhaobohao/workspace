package org.springexample.statemachine.sf.statemachine;


import org.springexample.statemachine.core.annotation.EnableWithStateMachine;
import org.springexample.statemachine.core.configurer.adapter.AbstractStateMachineConfigurerAdapter;
import org.springexample.statemachine.core.guard.DefaultGuard;
...
import org.springexample.statemachine.sf.action.CreateCardIIAction;
import org.springexample.statemachine.sf.action.DocumentCreditAction;
import org.springexample.statemachine.sf.action.FinishAction;
import org.springexample.statemachine.sf.action.GrantAction;
...
import org.springexample.statemachine.workflow.interceptor.PersistStateMachineInterceptor;
import lombok.extern.slf4j.Slf4j;
import org.springexample.statemachine.sf.enumerate.GrantConstant;
...
public class GrantStateMachineConfig extends AbstractStateMachineConfigurerAdapter<GrantState, GrantEvent> {
    ...
    public void configure(TransitionConfigurer<GrantState, GrantEvent> transitions) {
        transitions
                ...
                .first(GrantState.WAIT_GRANT, DefaultGuard.condition(GrantConstant.DOCUMENT_CREDIT_STATUS, GrantConstant.DOCUMENT_CREDIT_SUCCESS))
                //then相当于elseif，如果建档授信状态返回WAIT_DOCUMENT_CREDIT_CALLBACK则转换成等待建档授信回调
                .then(GrantState.WAIT_DOCUMENT_CREDIT_CALLBACK, DefaultGuard.condition(GrantConstant.DOCUMENT_CREDIT_STATUS, GrantConstant.WAIT_DOCUMENT_CREDIT_CALLBACK))
                ...
                .first(GrantState.GRANT_TASK_SAVE, DefaultGuard.condition(GrantConstant.GRANT_STATUS, GrantConstant.GRANT_SUCCESS))
